...
import com.hui.modules.member.dto.AccountDto;
...
import com.hui.modules.system.service.mapstruct.DictSmallMapper;
 ...
 * @date 2021-7-28
 */
@Mapper(componentModel = "spring", uses = {MemberSmallMapper.class}, unmappedTargetPolicy = ReportingPolicy.IGNORE)
